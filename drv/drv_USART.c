...
Usart_InitPeriph(
	...
	else if(ID_PinTX != PIN_NULL)  	xUSART_Init.USART_Mode = USART_Mode_Tx;
	else if(ID_PinRX != PIN_NULL) 	xUSART_Init.USART_Mode = USART_Mode_Rx;
	...
	USART_Init			( (USART_TypeDef*) Mapping_GPIO[ID_PinTX].Periph, &xUSART_Init		);
	USART_ClockInit			( (USART_TypeDef*) Mapping_GPIO[ID_PinTX].Periph, &USART_Clock_init	);
	...
	USART_Cmd			( (USART_TypeDef*) Mapping_GPIO[ID_PinTX].Periph, ENABLE );

	//---------- Save init
	__USART_SetInitializedState	( Mapping_GPIO[ID_PinTX].Periph, TRUE 	  );
	__USART_SetBaudRateState	( Mapping_GPIO[ID_PinTX].Periph, Baudrate );
